...
letters = {"a": "а", "b": "б", "c": "с", "d": "д", "e": "е", "f": "ф", "h": "х", "i": "й", "g": "г", "k": "к", "l": "л",
           "m": "м",
           "n": "н", "o": "о", "p": "п", "s": "с", "t": "т", "u": "ю", "r": "р", "v": "в", "w": "в", "y": "у", "z": "з"}
    ...
    if group_status == 'group' or group_status == 'supergroup':
        ...
        bot.send_message(chat_id=message.chat.id,
                         text='Hi! I was created only for moderation of group chats. If you want to see my potential '
                              ...
                              'If you did it, write /start in the group and I will send you instructions for use.')
        bot.send_sticker(chat_id=message.chat.id,
                         sticker='CAACAgIAAxkBAAJOvWYSrvx7emh-acTzaw88Ufdj4gYrAAKqFQAC_QcYS-3YFx7pAAEqfDQE')
        print(bot.get_chat(chat_id=message.chat.id).type)
        connection.close()
        return None
...
def text(message):
    ...
    group_status = bot.get_chat(chat_id=message.chat.id).type
    #если тип чата == группа
    if group_status == 'group' or group_status == 'supergroup':
        #если чат для рекламы
        if message.chat.id == -4149141572:
